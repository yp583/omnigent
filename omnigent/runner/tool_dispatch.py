    ...
    *,
    ...
    if tool_name == "sys_conductor_session_update":
        ...
        if action == "grant":
            ...
            level = {"read": 1, "edit": 2, "manage": 3}.get(level_name)
            if level is None:
        ...
        if action == "list":
            ...
            method, path, request_kwargs = "POST", "/v1/projects", {"json": payload}
        ...
        method, path, request_kwargs = "PATCH", "/v1/conductor", {"json": payload}
